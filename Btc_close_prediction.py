...
#Sacamos de una vez el real_data con los ultimos meses y el df usado
...
# Crear DataFrame con diciembre 2021 y enero 2022 ultimos meses
real_data = df.loc['2021-12':'2022-01']

# Crear DataFrame excluyendo esos meses para que no esten en el modelo
...
real_data.set_index('datetime', inplace=True)  # Establecemos fecha como índice
...
#NOTTAAA
#Si quisieras una seccion en especifica o tienes una base de datos de muchas criptos y solo buscas trabajar con btc
#se reduce a lo que quieres de la siguiente manera
#df_btc = df[df['Symbol'] == 'BTC'][['open', 'high', 'low']], si symbol fuera la columna con los tipos de criptos
